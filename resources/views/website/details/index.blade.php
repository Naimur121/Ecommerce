                        ...
                        <div class="large-5 column">
                            <div class="xzoom-container">
                                ...
                                <div class="xzoom-thumbs">
                                    <a href="{{ asset($product->image) }}"><img class="xzoom-gallery" width="80"
                                            src="{{ asset($product->image) }}" xpreview="{{ asset($product->image) }}"
                                            title="The description goes here"></a>
                                    @foreach ($product->otherImage as $images)
                                        <a href="{{ asset($images->image) }}"><img
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Brand:<a
                                    href="javascript:void(0)">{{ $product->brand->brand_name }}</a></p>
