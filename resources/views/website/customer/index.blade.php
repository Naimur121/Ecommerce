                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-4 p-sm-5">
                                    ...
                                    <div class="text-danger text-center">{{Session('messege')}}</div>
                                    <form class="form-body" action="{{route('customer.login')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="d-grid">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <p class="mb-0">Don't have an account yet? <a
                                                        href="{{route('customer.register')}}">Sign up here</a></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
