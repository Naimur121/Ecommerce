                ...
                <form class="form-horizontal p-t-20" action="{{ route('product.save') }}" method="POST"
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control @error('product_code') is-invalid @enderror"
                                        name="product_code" value="{{ old('product_code') }}" id="exampleInputEmail8"
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control @error('product_model') is-invalid @enderror"
                                        name="product_model" value="{{ old('product_model') }}" id="exampleInputEmail9"
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control @error('product_amount') is-invalid @enderror"
                                        name="product_amount" value="{{ old('product_amount') }}" id="exampleInputEmail10"
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="number"
                                        ...
                                        name="product_price" value="{{ old('product_price') }}" id="exampleInputEmail10"
                                        placeholder="Regulae Price">
                                    <input type="number"
                                        class="form-control @error('selling_price') is-invalid @enderror"
                                        name="selling_price" value="{{ old('selling_price') }}" id="exampleInputEmail11"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <textarea class="form-control summernote  @error('long_description') is-invalid @enderror"
                                    name="long_description" value="{{ old('long_description') }}"
                                    id="exampleInputEmail12"></textarea>
