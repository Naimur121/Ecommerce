...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_add1'] = $this->customer->address;
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        ...
        $this->order    = Order::orderBy('id', 'desc')->first()->id;
        OrderDetails::orderDetails($request, $this->order);
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                //     return redirect('/');
                // } else {
                //     Session::put('customer_id', Customer::orderBy('id', 'desc')->first()->id);
                //     Session::put('customer_name', Customer::orderBy('id', 'desc')->first()->name);
                //     return redirect('/');
                // }
